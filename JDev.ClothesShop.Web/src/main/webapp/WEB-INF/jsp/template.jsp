                    ...
                    <div class="twelve columns header_nav">
                        ...
                        <div class="twelve columns">
                            <ul id="menu-header" class="nav-bar horizontal">
                                ...
                                <li><a href="../index/index.do"><img src="../images/logo.png" alt="desc" style="border:none" /></a></li>

                                <li class=""><a href="../index/index.do">Trang Chủ</a></li>

                                <li class="has-flyout">
                                    <a href="../product/view.do?catalogue=-1">Sản phẩm</a><a href="#" class="flyout-toggle"></a>
                                    ...
                                    <ul class="flyout">
                                        ...
                                        %>
                                        <%="<li class='has-flyout'>"%>
                                        <%="<a href='../product/view.do?catalogue=" + danhMuc.getMaDanhMuc() + "'>" + danhMuc.getTenDanhMuc() + "</a>"%>
                                        <%="</li>"%>
                                        <%}%>
                                    </ul>
                                </li>
                ...
                <div class="row">
                    <div class="twelve columns">
                        <ul id="menu3" class="footer_menu horizontal">
                            <li class=""><a href="../index/index.do">Home</a></li>
                        </ul>
                    </div>
                </div>
